...
parser.add_argument('--gpu_id', type=int, default=1, help='Number of training epochs')
parser.add_argument('--n_epochs', type=int, default=50, help='Number of training epochs')
parser.add_argument('--data_folder', type=str, default='', help='Path to data.')
parser.add_argument('--optimizer_class', type=str, default='Adam', help='Path to data.')
parser.add_argument('--output_dir_name', type=str, default='FineTunedModels', help='Path to data.')
parser.add_argument('--imagemodel', type=str, default='vgg19', help='Path to data.')
parser.add_argument('--lr_value', type=float, default=1e-4, help='L2 regularisation')
parser.add_argument('--batch_size_value', type=int, default=16, help='L2 regularisation')
parser.add_argument('--layer_depth_vgg', type=int, default=8, help='L2 regularisation')
