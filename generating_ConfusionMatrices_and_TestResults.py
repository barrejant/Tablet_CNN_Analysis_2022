...
parser.add_argument('--model_class', type=str, default='resnet50', help='Path to data.')
parser.add_argument('--output_dir_name', type=str, default='', help='Path to data.')
parser.add_argument('--SideCuneiformDataset_dir', type=str, default='', help='Path to data.')
parser.add_argument('--FrontBottomCuneiformDataset_dir', type=str, default='', help='Path to data.')
parser.add_argument('--imagemodels_folder', type=str, default='', help='Path to data.')
...
imagemodelfile_list_ = glob.glob(os.path.join(args.imagemodels_folder, "**.pt"), recursive=True)
