...
if os.path.exists(output_dir_path):
    ...
    os.makedirs(os.path.join(output_dir_path, 'data'))
    ...
    for file in RecImage_File_List:
        ...
        for d in range(n_images_width):
            for c in range(n_images_height):
                ...
                img_crop.save(os.path.join(output_dir_path, 'data/' + file.split('/')[-1].split('.')[-2] + '_' + str(d).zfill(2) + '_' + str(c).zfill(2) + '.jpg'), quality=95)
